...
export default function App() {
  ...
  const layoutMode: "page" | "flow" = "flow";
  ...
  const activeMeasureForWindow = currentNote?.measure ?? 1;
  const rollingWindowFrom = Math.max(
    1,
    Math.min(activeMeasureForWindow - 1, Math.max(1, measureCount - measuresPerPage + 1))
  );
  const measureFrom = focusPracticeRange ? focusPracticeRange.from : rollingWindowFrom;
      ...
      <ScrollView style={styles.panel} contentContainerStyle={styles.panelContent}>
        ...
        <View style={styles.pageControls}>
          <Text style={styles.pageText}>
            {currentNote
              ? `\uD604\uC7AC ${currentNote.measure}\uB9C8\uB514 / \uC804\uCCB4 ${measureCount}\uB9C8\uB514`
              : `\uC804\uCCB4 ${measureCount}\uB9C8\uB514`}
          </Text>
        </View>
